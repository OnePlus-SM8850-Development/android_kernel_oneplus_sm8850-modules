...
#define TRACE_INCLUDE_PATH ../../vendor/oneplus/sm8850-modules/oplus/kernel/cpu/sched/frame_boost
#else
#define TRACE_INCLUDE_PATH ../../kernel_device_modules-6.12/kernel/oplus_cpu/sched/frame_boost
#endif
